...
const sendSignal = () => console.log("Сигнал отправлен DecoratorNew");
...
setTimeout(upgradedSendSignal, 2300); // проигнорировано??? сначала проигнорирована, потом сигнал отправлен так как времени от последнего вызова прошло: 2300-1200=1100 (1100 < 2000), а до следующего больше 2000
